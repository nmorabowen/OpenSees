...
- [[94_asdplastic_review_plan]] — **ADR 94 — ASDPlasticMaterial3D implementation review**: warrant-first review of jaabell's framework + the fork's HB/StiffSoil/MCTC layer; 15-item H-list (class-static tangent, silent-accept sites, HB drift vs `jaabell/ASDP`), R0–R6 phases, per-phase agent/model assignments. Draft 2026-09-06.
