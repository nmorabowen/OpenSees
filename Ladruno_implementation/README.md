...
- [[94_asdplastic_review_plan]] — **ADR 94 — ASDPlasticMaterial3D implementation review**: VERDICT SHIPPED 2026-09-07 ([[reviews/adr94_verdict]], #804): 15/16 hypotheses confirmed; blockers = silent parser, fail-loud unreachable on hex hosts, elastic-predictor commit under softening, DP apex NaN, shear-slot convention split; class-static tangent is cost + threading blocker (results exact). Fixes are separate `wp/94a-e` + jaabell-bound items.
