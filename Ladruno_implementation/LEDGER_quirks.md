...
### 2D NTS open-chain ENDS are a Newton-killing force discontinuity -- a tilting master drops its boundary slaves off the surface end (fixed with a terminal-side acceptance window; radial end-caps owed)
