...
| `SRC/actor/objectBroker/FEM_ObjectBrokerAllClasses.cpp` | Broker `getNewElement/Integrator/Recorder` entries for the new class tags above (incl. `ELE_TAG_LadrunoBrick` → `new LadrunoBrick()` + `#include "ladrunoBrick/LadrunoBrick.h"`) | [#2](https://github.com/nmorabowen/OpenSees/pull/2), [#6](https://github.com/nmorabowen/OpenSees/pull/6), [#8](https://github.com/nmorabowen/OpenSees/pull/8), [#65](https://github.com/nmorabowen/OpenSees/pull/65) |
...
| `SRC/element/CMakeLists.txt` | `add_subdirectory(bezierTriangle)` + `add_subdirectory(bezierTetrahedron)` + `add_subdirectory(ladrunoBrick)` | [#6](https://github.com/nmorabowen/OpenSees/pull/6), [#65](https://github.com/nmorabowen/OpenSees/pull/65), _pending (BezierTet10)_ |
