...
| `SRC/classTags.h` | Register Ladruno class tags (private band ≥33000): `ELE_TAG_BezierTri6`=33000, `ELE_TAG_BezierTet10`=33001, `INTEGRATOR_TAGS_ExplicitBathe`=33000…`CentralDifferenceLadruno`=33003, `RECORDER_TAGS_EnergyBalanceRecorder`=33000, `RECORDER_TAGS_LadrunoRecorder`=33001 | [#2](https://github.com/nmorabowen/OpenSees/pull/2), [#6](https://github.com/nmorabowen/OpenSees/pull/6), [#8](https://github.com/nmorabowen/OpenSees/pull/8), [#21](https://github.com/nmorabowen/OpenSees/pull/21), [#25](https://github.com/nmorabowen/OpenSees/pull/25), _pending (BezierTet10)_ |
...
| `SRC/interpreter/OpenSeesElementCommands.cpp` | Register `element` dispatch for `BezierTri6` and `BezierTet10` (fwd-decl + `functionMap`) | [#6](https://github.com/nmorabowen/OpenSees/pull/6), _pending (BezierTet10)_ |
| `SRC/element/CMakeLists.txt` | `add_subdirectory(bezierTriangle)` + `add_subdirectory(bezierTetrahedron)` | [#6](https://github.com/nmorabowen/OpenSees/pull/6), _pending (BezierTet10)_ |
