...
| `SRC/classTags.h` | Register Ladruno class tags: `ELE_TAG_BezierTri6`=272, `INTEGRATOR_TAGS_ExplicitBathe`=61, `…ExplicitBatheLNVD`=63, `RECORDER_TAGS_EnergyBalanceRecorder`=26, `RECORDER_TAGS_MPCOLadrunoRecorder`=27 | [#2](https://github.com/nmorabowen/OpenSees/pull/2), [#6](https://github.com/nmorabowen/OpenSees/pull/6), [#8](https://github.com/nmorabowen/OpenSees/pull/8) |
...
| `SRC/interpreter/OpenSeesOutputCommands.cpp` | Register `recorder` keywords for EnergyBalance and MPCO_Ladruno | [#2](https://github.com/nmorabowen/OpenSees/pull/2), [#8](https://github.com/nmorabowen/OpenSees/pull/8) |
