...
| **P3** | `wp/97d-cp-hoekbrown` | HoekBrown principal-space return (Clausen & Damkilde 2008) with analytic principal derivatives; the `HoekBrown_PF::g` / composite-`f` tension mismatch. Support rises to **43 of 46**. | opus | 1 session |
...
The remaining 3 (the StiffSoil trio) are **refused at parse time** under
