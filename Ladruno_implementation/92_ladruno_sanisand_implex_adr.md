...
dense-refuse arm (still owed, at build hash with `-implexFactor controlIter`) decides
whether it ships. `fixed` remains the default and the thing to reach for.
