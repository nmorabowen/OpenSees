...
project: Ladruno
status: SHIPPED (C4.0 oracle proto_c4_mortar_tie.py + C4.1 penalty tie force/tangent + C4.2 ALM, #381). ADR-41 mortar lane DONE (C1→C4). Battery 75/75. Next: ADR-47 (dual basis / true-LM / self-contact).
owner: nmora
tags:
  - implementation
  - contact
