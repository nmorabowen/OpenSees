...
ops.recorder("ladruno", q_new, "-N", "displacement", "-E", "stress", "-T", "dt", 0.0)
...
ops.recorder("ladruno", t_new, "-N", "displacement", "-E", "stress", "-T", "dt", 0.0)
ops.timeSeries("Linear", 1)
ops.pattern("Plain", 1, 1)
ops.load(2, 1.0e2, 0.0)
ops.system("BandSPD")
...
ops.recorder("ladruno", b_new, "-N", "displacement", "-E", "stress", "-T", "dt", 0.0)
ops.timeSeries("Linear", 1)
ops.pattern("Plain", 1, 1)
...
ops.recorder("ladruno", q9_new, "-N", "displacement", "-T", "dt", 0.0)
ops.timeSeries("Linear", 1)
ops.pattern("Plain", 1, 1)
ops.load(2, 1.0e2, 0.0)
ops.load(3, 1.0e2, 0.0)
...
ops.recorder("ladruno", t10_new, "-N", "displacement", "-T", "dt", 0.0)
ops.timeSeries("Linear", 1)
ops.pattern("Plain", 1, 1)
...
ops.recorder("ladruno", h20_new, "-N", "displacement", "-T", "dt", 0.0)
ops.timeSeries("Linear", 1)
ops.pattern("Plain", 1, 1)
for n in (5, 6, 7, 8):
