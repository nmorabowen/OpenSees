# P0 serial reference in TCL — mirrors model.py exactly (GAP0 = 1e-3).
# Bottom block = MASTER, top block = SLAVE, lateral DOFs fixed => 1-D column.
wipe
...
puts [format "P0TCL analyze=%d w15=%.15e w11=%.15e w5=%.15e R=%.10e" \
      $ok [nodeDisp 15 3] [nodeDisp 11 3] [nodeDisp 5 3] $R]
wipe
