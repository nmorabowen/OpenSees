...
:Element (0,ELE_TAG_Tri31),
  theMaterial(0), connectedExternalNodes(3), Q(6), pressureLoad(6), thickness(0.0), pressure(0.0), rho(0.0), Ki(0) // Ladruno: init rho (upstream DB/parallel restart mass bug)
{
	pts[0][0] = 0.333333333333333;
	pts[0][1] = 0.333333333333333;
