...
"        • LadrunoContact — NTS + mortar/ALM contact (penalty + commit-cycle Uzawa, Coulomb/Tresca friction, mesh-tying, viscous stabilization, consistent dn/du normal tangent, SOFT=1 + SOFT=2 Courant-stable explicit penalty, finite-sliding re-emit, averaged nodal-normal smoothing -smoothNormal w/ convex-ridge facet ownership; 2D plane lane -- T0: rigid plane + declarations (dimension-consistent surfaces from node coordinates, 7-arg contactPlane); T1b: frictionless NTS pairs + concave-vertex corners live (interface-level orientation vote, 2-component -outward, auto-kn, -visc dashpot, -soft); 2D friction lands in T2, 2D mortar/tie in T3 -- refused by name)\n"
