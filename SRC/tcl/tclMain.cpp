...
"        • MohrCoulombTensionCutoff (ASDPlastic) — MC + Rankine cutoff composite YF/PF, exact face/edge/corner/compound/vertex returns in Backward_Euler, TC_min_stress runtime-rampable\n"
"\n";
    // FEATURES-END
