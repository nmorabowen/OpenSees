...
"        • system Pardiso — threaded MKL PARDISO desktop sparse-direct solver (symbolic/numeric/solve split for factorization reuse; -matrixType 1|2 symmetric upper-triangle half-storage = 1.35x faster + 42% less peak memory, exact; -stats peak-memory counters; Tcl + Python)\n"
"\n";
    // FEATURES-END
