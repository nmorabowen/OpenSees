...
"        • LadrunoTie — kinematic non-conforming mesh-tie generator (collocation + integral-mortar; solid + ndf-6 shell rotational DOFs; emits EQ-constraints for LadrunoProjection; exact, dt_cr-neutral)\n"
