...
"        • LadrunoContact — NTS + mortar/ALM contact (penalty + commit-cycle Uzawa, Coulomb/Tresca friction, mesh-tying, viscous stabilization, consistent dn/du normal tangent, SOFT=1 + SOFT=2 Courant-stable explicit penalty, finite-sliding re-emit, averaged nodal-normal smoothing -smoothNormal w/ convex-ridge facet ownership; 2D plane lane (T0: rigid plane + declarations) -- dimension-consistent surfaces from node coordinates, nodesPerSeg 2 line segments, 7-arg contactPlane, NTS/mortar 2D refused by name until T1b/T3)\n"
