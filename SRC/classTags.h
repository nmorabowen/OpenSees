...
#define ELE_TAG_LadrunoSolidShell          33020 // N. Mora-Bowen (Ladruno) — 8-node ANS/EAS solid-shell (ADR 64): 3-translational-DOF punching/bearing specialist carrying the full triaxial sigma_33 through shell geometry; Dvorkin-Bathe ANS transverse shear + Betsch-Stein ANS E33 + state-dependent EAS-on-E33 (committed alpha, adapted LadrunoBrick formEAStrue); 2x2 in-plane x selectable nz gauss/lobatto; in-plane-projected lch; NOT a co-equal flexural host. 33020 honored as reserved by ADR 19 — 33016-33019 remain free ELE slots; ladruno private band >=33000 (see Ladruno_implementation/64_ladruno_solidshell_adr.md)
