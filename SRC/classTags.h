...
#define MAT_TAG_LadrunoRebarBuckling 33001 // N. Mora-Bowen (Ladruno) — Dhakal-Maekawa rebar-buckling WRAPPER over any bare-bar uniaxial material; ladruno private uniaxial band >=33000
