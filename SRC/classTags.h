...
#define ELE_TAG_LadrunoQuad                33006 // N. Mora-Bowen (Ladruno) — unified 4-node plane (plane-stress/strain) continuum, -formulation {std|bbar|ssp|eas}; 2D sibling of LadrunoBrick; ladruno private band >=33000 (see Ladruno_implementation/25_ladruno_plane_elements_adr.md)
#define ELE_TAG_LadrunoCST                 33007 // N. Mora-Bowen (Ladruno) — 3-node constant-strain triangle (std only); thin 2D sibling of LadrunoQuad; ladruno private band >=33000 (see Ladruno_implementation/25_ladruno_plane_elements_adr.md)
