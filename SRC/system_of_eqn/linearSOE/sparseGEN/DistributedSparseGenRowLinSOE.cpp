...
{
    if (vectX == 0) {
	opserr << "WARNING DistributedSparseGenRowLinSOE::getX - the SOE has not been sized yet "
...
{
    if (vectB == 0) {
	opserr << "WARNING DistributedSparseGenRowLinSOE::getB - the SOE has not been sized yet "
