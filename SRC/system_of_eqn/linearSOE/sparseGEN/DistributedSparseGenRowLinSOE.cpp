...
{
    if (vectX == 0) {
	opserr << "WARNING DistributedSparseGenRowLinSOE::getX - the SOE has not been sized "
...
{
    if (vectB == 0) {
	opserr << "WARNING DistributedSparseGenRowLinSOE::getB - the SOE has not been sized "
